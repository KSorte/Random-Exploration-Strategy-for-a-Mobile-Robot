...
class RandomExplorer:
    ...
    def sampling(self):
        ...
        while not rospy.is_shutdown():
            ...
            rospy.loginfo("Inside main while")
            ...
            while status != GoalStatus.SUCCEEDED and (rospy.Time.now() - last_sample_time).to_sec() < 20:
            ...
            elif (rospy.Time.now() - last_sample_time).to_sec() > 15 :
